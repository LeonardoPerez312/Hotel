    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 d-flex">
            ...
            <div class="d-flex flex-column">
                <div class="info">
                    <a href="<?= "$baseURL/views/modules/dia/show.php?id=" .$_SESSION['UserInSession']['id']?>" class="d-block">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?= strpos($_SERVER['REQUEST_URI'],'dia') ? 'menu-open' : '' ?>">
                    <a href="#" class="nav-link <?= strpos($_SERVER['REQUEST_URI'],'dia') ? 'active' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= $baseURL ?>/views/modules/dia/index.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Gestionar</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= $baseURL ?>/views/modules/dia/create.php" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Registrar</p>
                            </a>
                        </li>
