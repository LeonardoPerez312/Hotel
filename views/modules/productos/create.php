                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <div class="form-group row">
                                                <label for="nombres" class="col-sm-2 col-form-label">Nombres Producto</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="number" minlength="6" class="form-control"
                                                           id="cantidad" name="cantidad" placeholder="Ingrese su telefono"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="number" minlength="6" class="form-control"
                                                           id="precio" name="precio" placeholder="Ingrese su telefono"
                                                           value="<?= $frmSession['precio'] ?? '' ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inventario_idproducto" class="col-sm-2 col-form-label">Productos</label>
                                                <div class="col-sm-10 ">
                                            ...
                                            <div class="form-group row">
                                                <label for="ventas_idventas" class="col-sm-2 col-form-label">Ventas</label>
                                                <div class="col-sm-10 ">
                                                    <?= ventasController::selectCategoria(
                                                        array(
                                                            'id' => 'ventas_idventas',
                                                            'name' => 'ventas_idventas',
                                                            'defaultValue' => (!empty($frmSession['ventas_idventas'])) ? $frmSession['ventas_idventas'] : '',
                                                            'class' => 'form-control select2bs4 select2-info',
                                                            'where' => "estado = 'Activo'"
                                                        )
                                                    );
