                                ...
                                if (!empty($Dataproductos)) {
                                    ...
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-info"></i> &nbsp; Ver Información
                                            de <?= $Dataproductos->getNombres() ?></h3>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <p>
                                                    <strong><i class="fas fa-book mr-1"></i> Nombres Producto
                                                       </strong>
                                                <p class="text-muted">
                                                    <?= $Dataproductos->getNombres() ?>
                                                </p>
                                                <hr>
                                                <strong><i class="fas fa-user mr-1"></i> Precio</strong>
                                                <p class="text-muted"><?= $Dataproductos->getPrecio()  ?></p>
                                                <hr>
                                                <strong><i class="fas fa-map-marker-alt mr-1"></i> Precio Venta</strong>
                                                <p class="text-muted"><?= $Dataproductos->getPrecioVenta() ?>

                                                <strong><i class="fas fa-calendar-check mr-1"></i> Fecha
                                                    Registro</strong>
                                                <p class="text-muted"><?= $Dataproductos->getCreatedat()->toDateTimeString(); ?></p>
                                                <hr>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $Dataproductos->getId(); ?>"
