                                            ...
                                            <div class="col-sm-10">
                                                <p>
                                                    <strong><i class="fas fa-book mr-1"></i> Nombres y
                                                        Apellidos</strong>
                                                <p class="text-muted">
                                                    <?= $Dataclientes->getNombres() . " " . $Dataclientes->getApellidos() ?>
                                                </p>
                                                <hr>
                                                <strong><i class="fas fa-user mr-1"></i> Documento</strong>
                                                <p class="text-muted"><?= $Dataclientes->getTipoDocumento() . ": " . $Dataclientes->getDocumento() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-map-marker-alt mr-1"></i> Direccion</strong>
                                                <p class="text-muted"><?= $Dataclientes->getDireccion() ?>

                                                <strong><i class="fas fa-phone mr-1"></i> Celular</strong>
                                                <p class="text-muted"><?= $Dataclientes->getCelular() ?></p>
                                                <hr>

                                                <hr>
                                                <strong><i class="fas fa-map-marker-alt mr-1"></i> Ciudad</strong>
                                                <p class="text-muted"><?= $Dataclientes->setCiudad() ?>


                                                    <strong><i class="fas fa-calendar-check mr-1"></i> Fecha
                                                    Registro</strong>
                                                <p class="text-muted"><?= $Dataclientes->getCreatedat()->toDateTimeString(); ?></p>

                                                <strong><i class="fas fa-calendar-check mr-1"></i> hora
                                                    Registro</strong>
                                                <p class="text-muted"><?= $Dataclientes->getHora()->toDateTimeString(); ?></p>

                                                <strong><i class="fas fa-user mr-1"></i> Gasto lavanderia</strong>
                                                <p class="text-muted"><?= $Dataclientes-> getGastosLabanderia() . ": " . $Dataclientes-> getGastosLabanderia() ?></p>
                                                <hr>
                                                <hr>
