                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="number" minlength="6" class="form-control"
                                                           id="celular" name="celular" placeholder="Ingrese su telefono"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input required type="text" class="form-control" id="nombres" name="ciudad"
                                                           placeholder="Ingrese sus nombres" value="<?= $frmSession['ciudad'] ?? '' ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 ">
                                                <?= CategoriasController::selectCategoria(
                                                    array(
                                                        'id' => 'habitaciones_idhabitaciones',
                                                        'name' => 'habitaciones_idhabitaciones',
                                                        'defaultValue' => (!empty($frmSession['habitaciones_idhabitaciones'])) ? $frmSession['habitaciones_idhabitaciones'] : '',
