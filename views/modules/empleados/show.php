                                ...
                                if (!empty($Dataempleados)) {
                                            ...
                                            <div class="col-sm-10">
                                                <p>
                                                    <strong><i class="fas fa-book mr-1"></i> Nombres y
                                                        Apellidos</strong>
                                                <p class="text-muted">
                                                    <?= $Dataempleados->getNombres() . " " . $Dataempleados->getApellidos() ?>
                                                </p>
                                                <hr>
                                                <strong><i class="fas fa-user mr-1"></i> Documento</strong>
                                                <p class="text-muted"><?= $Dataempleados->getTipoDocumento() . ": " . $Dataempleados->getDocumento() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-map-marker-alt mr-1"></i> Direccion</strong>
                                                <p class="text-muted"><?= $Dataempleados->getDireccion() ?>

                                                <strong><i class="fas fa-phone mr-1"></i> Celular</strong>
                                                <p class="text-muted"><?= $Dataempleados->getCelular() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-phone mr-1"></i> Salario</strong>
                                                <p class="text-muted"><?= $Dataempleados->getSalario() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-phone mr-1"></i> Turno</strong>
                                                <p class="text-muted"><?= $Dataempleados->getTurno() ?></p>
                                                <hr>
                                            </div>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $Dataempleados->getId(); ?>"
