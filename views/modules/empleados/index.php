                                ...
                                <div class="row">
                                    <div class="col">
                                        <table id="tbl<?= $pluralModel ?>" class="datatable table table-bordered table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                            $arrempleados = epleadosController::getAll();
                                            /* @var $arrEmpleados Usuarios[] */
                                            foreach ($empleados as $clientes) {
                                                ?>
                                                <tr>
                                                    <td><?= $empleados->getId(); ?></td>
                                                    <td><?= $empleados->getNombres(); ?></td>
                                                    <td><?= $empleados->getApellidos(); ?></td>
                                                    <td><?= $empleados->getTipoDocumento(); ?></td>
                                                    <td><?= $empleados->getDocumento(); ?></td>
                                                    <td><?= $empleados->getCelular(); ?></td>
                                                    <td><?= $empleados->getSalario(); ?></td>
                                                    <td><?= $empleados-> getTurno(); ?></td>
