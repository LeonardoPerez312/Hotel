                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" method="post" id="<?= $nameForm ?>"
                                    ...
                                    <div class="form-group row">
                                        <label for="gastos_idgastos" class="col-sm-2 col-form-label">Nombre inventario</label>


                                        <div class="form-group row">
                                            <label for="gastos_idgastos" class="col-sm-2 col-form-label">Dia</label>
                                            <div class="col-sm-10 ">
                                                <?= empleadosController::selectCategoria(
                                                    array(
                                                        'id' => 'Dia_id',
                                                        'name' => 'Dia_id',
                                                        'defaultValue' => (!empty($frmSession['Dia_id'])) ? $frmSession['Dia_id'] : '',
                                    ...
                                    <div class="form-group row">
                                        <label for="Mes_id" class="col-sm-2 col-form-label">Mes</label>
                                        <div class="col-sm-10 ">
                                            <?= empleadosController::selectCategoria(
                                                array(
                                                    'id' => 'Mes_id',
                                                    'name' => 'Mes_id',
                                                    'defaultValue' => (!empty($frmSession['Mes_id'])) ? $frmSession['Mes_id'] : '',
                                                    'class' => 'form-control select2bs4 select2-info',
                                                    'where' => "estado = 'Activo'"
                                                )
                                            );
