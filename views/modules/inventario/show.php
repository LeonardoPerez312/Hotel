                                ...
                                if (!empty($Datainventario)) {
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                ...
                                                <p class="text-muted"><?= $Dataclientes->getDiaIngresosIdingresos() ?>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $Datainventario->getId(); ?>"
