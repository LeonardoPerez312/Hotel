                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) { ?>
                                ...
                                $Datalimpiessa = limpiesaController::searchForID(["id" => $_GET["id"]]);
                                /* @var $Datalimpiesa limpiesa */
                                if (!empty($Datalimpiesa)) {
                                    ?>
                                    <!-- form start -->
                                    <div class="card-body">
                                        <form class="form-horizontal" enctype="multipart/form-data" method="post" id="<?= $nameForm ?>"
                                            ...
                                            <input id="id" name="id" value="<?= $Datalimpiesa->getId(); ?>" hidden
                                                   required="required" type="text">
                                            <div class="row">


                                                    <div class="form-group row">
                                                        <label for="nuemro_habitacion" class="col-sm-2 col-form-label">Numero Habitacion</label>
                                                        <div class="col-sm-10">
                                                            <input required type="number" minlength="6" class="form-control"
                                                                   id="nuemro_habitacion" name="nuemro_habitacion"
                                                                   value="<?= $Datalimpiesa->getNuemroHabitacion(); ?>"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input required type="date" max="<?= Carbon::now()->subYear(12)->format('Y-m-d') ?>"
                                                                   value="<?= $Datalimpiesa->getFechaNacimiento()->toDateString(); ?>" class="form-control" id="fecha_nacimiento"
