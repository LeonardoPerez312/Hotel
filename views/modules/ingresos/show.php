                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-green">
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) {
                                $Dataingresos = clientesController::searchForID(["id" => $_GET["id"]]);
                                /* @var $Dataingresos clientes */
                                if (!empty($Dataingresos)) {
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                ...
                                                <p class="text-muted"><?= $Dataingresos->getVolor() ?></p>
                                                <hr>
                                                <strong><i class="fas fa-calendar-check mr-1"></i> Fecha
                                                    Registro</strong>
                                                <p class="text-muted"><?= $Dataingresos->getCreatedat()->toDateTimeString(); ?></p>
                                                <hr>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $Dataingresos->getId(); ?>"
