                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) { ?>
                                ...
                                $Dataingresos = ingresosController::searchForID(["id" => $_GET["id"]]);
                                /* @var $Dataingresos ingresos */
                                if (!empty($Dataingresos)) {
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" enctype="multipart/form-data" method="post" id="<?= $nameForm ?>"
                                            ...
                                            <input id="id" name="id" value="<?= $Dataingresos->getId(); ?>" hidden
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input required type="date" max="<?= Carbon::now()->subYear(12)->format('Y-m-d') ?>"
                                                                   value="<?= $Dataingresos->getFecha()->toDateString(); ?>" class="form-control" id="fecha_nacimiento"
