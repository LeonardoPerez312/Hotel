                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                ...
                                                <strong><i class="fas fa-map-marker-alt mr-1"></i> ingreso dia valor</strong>
                                                <p class="text-muted"><?= $Dataclientes->getIngresoDia () ?>

                                                    <strong><i class="fas fa-map-marker-alt mr-1"></i> Persona</strong>
                                                <p class="text-muted"><?= $Dataclientes->getPersona () ?>

                                                    <strong><i class="fas fa-map-marker-alt mr-1"></i> Turno</strong>
                                                <p class="text-muted"><?= $Dataempledos->getPersona () ?>
