                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-green">
                            <?php if (!empty($_GET["id"]) && isset($_GET["id"])) {
                                $Datagastos = gastosController::searchForID(["id" => $_GET["id"]]);
                                /* @var $Datagastos gastos */
                                if (!empty($Dataclientes)) {
                                    ?>
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-info"></i> &nbsp; Ver Información
                                            de <?= $Datagastos->getNombresGasto() ?></h3>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <p>
                                                    <strong><i class="fas fa-book mr-1"></i> Nombres gasto</strong>
                                                <p class="text-muted">
                                                    <?= $Datagastos->getNombres() . " " . $Datagastos->getApellidos() ?>
                                                </p>
                                                <hr>
                                                <strong><i class="fas fa-user mr-1"></i> Valor</strong>
                                                <p class="text-muted"><?= $Datagastos->getValor() . ": " . $Datagastos->getDocumento() ?></p>

                                                <hr>
                                                <strong><i class="fas fa-calendar-check mr-1"></i> Fecha
                                                    Registro</strong>
                                                <p class="text-muted"><?= $Datagastos->getCreatedat()->toDateTimeString(); ?></p>
                                                <hr>
                                    ...
                                    <div class="card-footer">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <a role="button" href="edit.php?id=<?= $Datagastos->getId(); ?>"
