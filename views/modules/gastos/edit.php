                                ...
                                if (!empty($Datagastos)) {
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" enctype="multipart/form-data" method="post" id="<?= $nameForm ?>"
                                            ...
                                            <input id="id" name="id" value="<?= $Datagastos->getId(); ?>" hidden
                                            ...
                                            <div class="row">
                                                <div class="col-sm-10">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input required type="text" class="form-control" id="nombres"
                                                                   name="nombres" value="<?= $Datagastos->getNombres(); ?>"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input required type="text" class="form-control" id="direccion"
                                                                   name="direccion" value="<?= $Datagastos->getDireccion(); ?>"
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="salario" class="col-sm-2 col-form-label">Salariio</label>
                                                        <div class="col-sm-10">
                                                            <input required type="number" minlength="6" class="form-control"
                                                                   id="Celular" name="Celular"
                                                                   value="<?= $Datagastos->getCelular(); ?>"
