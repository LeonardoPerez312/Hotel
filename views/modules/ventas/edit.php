                                ...
                                if (!empty($Dataventas)) {
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" enctype="multipart/form-data" method="post" id="<?= $nameForm ?>"
                                            ...
                                            <input id="id" name="id" value="<?= $Dataventas->getId(); ?>" hidden
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input required type="text" class="form-control" id="nombres"
                                                                   name="nombres" value="<?= $Dataventas->getNombres(); ?>"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input required type="date" max="<?= Carbon::now()->subYear(12)->format('d-h') ?>"
                                                                   value="<?= $Dataventas->getFecha()->toDateString(); ?>" class="form-control" id="fecha_nacimiento"
